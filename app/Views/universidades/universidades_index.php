                            ...
                            <?php foreach ($universidades as $universidade) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="actions">
                                            <a href="<?= base_url('/universidades/editar/' . $universidade['universidade_id']) ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a id="<?= $universidade['universidade_id'] ?>" type="button" data-toggle="modal" data-target="#exampleModal" onclick="deleteModal(this.id)" data-detalhes='<?= json_encode($universidade) ?>'><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
