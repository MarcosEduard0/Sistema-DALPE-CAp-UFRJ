...
$(function(){
    $('#filImage').change(function(){
        ...
        fileReader.onloadend = function(){
            $('#imgLicen').attr('src',fileReader.result);
        }
...
$(document).ready(function() {
    $('#tabela').DataTable({
        "language": {
            ...
            "infoEmpty": "Sem dados disponível",
...
// funcao para o funcionamento dos tolltip
$(function () {
    $('[data-toggle="tooltip"]').tooltip()
  });

//função para animação na validação dos formularios
(function() {
  'use strict';
